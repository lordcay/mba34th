...
const socket = io('http://192.168.100.4:4000'); // ✅ Replace with your IP
...
const ChatRoomDetailScreen = ({ route }) => {
    ...
    useEffect(() => {
        const fetchMessages = async () => {
            try {
                const res = await axios.get(`http://192.168.100.4:4000/api/chatroom-messages/${chatroomId}/messages`);
